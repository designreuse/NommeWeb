package com.amazonaws.sns.tools;
...
import com.amazonaws.sns.mobilepush.SNSMobilePush;
...
public class SampleMessageGenerator {
	...
	private static Map<String, String> getData() {
		...
		payload.put("message", SNSMobilePush.content);
		return payload;
	}
	...
	public static String getSampleAppleMessage() {
		...
		appMessageMap.put("alert", SNSMobilePush.content);
