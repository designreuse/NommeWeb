...
public class StripeUtil {
	...
	public static String getPublishableKey()
	{
		...
		if (key == null)
		{
			System.out.println("ERROR: Stripe publishable key not defined. The environment variable " + variable + " must be set.");
			return null;
		}
